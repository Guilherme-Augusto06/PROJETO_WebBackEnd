...
document.addEventListener('DOMContentLoaded', function() {
  ...
  async function carregarDespesas() {
    try {
      // Carrega as despesas
      const responseDespesas = await axios.get('https://apigerenciamentofinanceiro.augustin06.repl.co/list');
      const despesas = responseDespesas.data;

      // Carrega o salário
      const responseSalario = await axios.get('https://apigerenciamentofinanceiro.augustin06.repl.co/list_salary');
  ...
  async function carregarGrafico() {
    try {
      ...
      const responseTotalDespesas = await axios.get('https://apigerenciamentofinanceiro.augustin06.repl.co/sum');
  ...
  async function adicionarDespesa() {
    ...
    try {
      ...
      const response = await axios.post(`https://apigerenciamentofinanceiro.augustin06.repl.co/add`, { despesa: despesa, valor: valor })
...
function excluirDespesa(id) {
  ...
  if (confirmacao) {
    axios.delete('https://apigerenciamentofinanceiro.augustin06.repl.co/delete', { data: { id } })
      .then(function(response) {
        location.reload();
        console.log(response.data);
...
async function editarDespesaConfirmado() {
  ...
  try {
    const response = await axios.put(`https://apigerenciamentofinanceiro.augustin06.repl.co/update/${id}`, { despesa: novoDespesa, valor: novoValor })
      .then(function(response) {
        location.reload();
        console.log(response.data);
...
async function editarSalario() {
  ...
  try {
    const response = await axios.put('https://apigerenciamentofinanceiro.augustin06.repl.co/update_salary', { salario: novoSalario })
      .then(function(response) {
        location.reload();
        console.log(response.data);
      })
